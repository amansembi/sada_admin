...
{
$sql=mysqli_query($con,"INSERT INTO  `user_info`(`service_name`,`username`, `dob`, `mobile`, `p_code`, `email`, `guid`, `address`, `gender`, `skin_analise`, `surgery`, `pregnant`, `ailments`, `note`)
